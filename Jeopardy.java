...
if (buttonPressed == firstButton) {
	askQuestion("What is 4+6/2*5", "19", 100);
}
if (buttonPressed == secondButton) {
	askQuestion("Glenn needs 1,500 boards to build a small rocket. \n"
			+ "Each board must be 3 feet long. If boards are sold in 12 foot lengths,\n"
			+" how many boards must Glenn buy and cut into 3 foot pieces to get the 1,500 \n"
			+ "he needs?", "375", 200);
}
